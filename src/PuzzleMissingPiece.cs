...
public class PuzzleMissingPiece : Game
{
	...
	public override string Answer {
		get { 
			...
			answer += Catalog.GetString ("In every row the third square is made by flipping the first square and overlapping it to the second square, removing the matching lines, and then flipping the resulting image.");
			return answer;
		}
	}
